...
public class Constants {
	...
	public static String GUEST_USERNAME = "mr.guest@outlook.com";
    ...
    public static final String FRESCO            = "media/accounts/default.png";
	public static final String DEFAULT_IMAGE_URI = "media/accounts/default.png";
